...
- [x] 正式 full_run 后台运行：已完成 213 个 shard，18 个 shard 正在 running；最新 generation_rows `19356`、error_rows `0`，estimated_records `294053`，completion_fraction `0.06582486830605368`；recent_rows_per_minute `70.86755165050552`，ETA 约 `64.60337949745828` 小时；health summary 为 `ok`。
