...
- [ ] 使用真实 Qwen3-8B endpoint 跑完全量 Exp0-Exp6 generation。目前已完成 267 个 shard，并由 supervisor/maintainer 维持运行；尚未完成全量 1792 个 job。
