...
- [x] 服务器 `python -m pytest -q`，结果：137 passed。
...
- [x] 正式 full_run 后台运行：已完成 138 个 shard，18 个 shard 正在 running；最近检查 generation_rows `13138`、error_rows `0`，health summary 为 `ok`。
