...
- [x] 正式 full_run 后台运行：已完成 195 个 shard，18 个 shard 正在 running；最近检查 generation_rows `17917`、error_rows `0`，estimated_records `294053`，completion_fraction `0.06093119267615022`；health summary 为 `ok`。
