...
- [x] 服务器 `python -m pytest -q`，结果：183 passed。
...
- [x] 正式 full_run 后台运行：已完成 231 个 shard，18 个 shard 正在 running；最新 generation_rows `20911`、error_rows `0`，estimated_records `294053`，completion_fraction `0.07111303064413559`；recent_rows_per_minute `71.33451968073247`，ETA 约 `63.817162953383786` 小时；health summary 为 `ok`。
