...
- [x] 正式 full_run 后台运行：已完成 28 个 shard，18 个 shard 正在 running；最近检查 generation_rows `3381`、error_rows `0`，近期吞吐约 `84.10` rows/min，粗略 ETA 约 `39.83` hours，GPU2/GPU3 均 100% utilization，health summary 为 `ok`。
