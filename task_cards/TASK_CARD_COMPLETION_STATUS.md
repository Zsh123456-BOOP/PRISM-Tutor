...
- [x] 本机 `python -m pytest -q`，结果：193 passed。
...
- [x] 正式 full_run 后台运行：已完成 267 个 shard，18 个 shard 正在 running；最新 generation_rows `24660`、error_rows `0`、raw_error_rows `79`，estimated_records `294053`，completion_fraction `0.08386243296276522`；recent_rows_per_minute `76.42316807285879`，ETA 约 `58.750290606283926` 小时；health summary 为 `ok`。
