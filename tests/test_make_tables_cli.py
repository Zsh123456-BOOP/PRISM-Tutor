...
def test_make_tables_writes_all_task_card_tables_and_significance(tmp_path: Path) -> None:
    ...
    rows = [
        {"dataset": "mathdial", "sample_id": "s1", "method": "ours_full", "internal_correctness": 1.0, "total_tokens": 100, "rule_leakage": 0},
        {"dataset": "mathdial", "sample_id": "s1", "method": "fixed_4", "internal_correctness": 0.0, "total_tokens": 120, "rule_leakage": 1},
        ...
        {"dataset": "mathdial", "sample_id": "s2", "method": "ours_full", "internal_correctness": 1.0, "total_tokens": 110, "rule_leakage": 0},
        {"dataset": "mathdial", "sample_id": "s2", "method": "fixed_4", "internal_correctness": 0.0, "total_tokens": 130, "rule_leakage": 1},
